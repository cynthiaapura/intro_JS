document.addEventListener("DOMContentLoaded", e => {
    ...
    let age, element_title, x, y, content, element_article, dates_footer, new_element;
    ...
    // on ajoute le nouvel élément à l'élément existant (ici l'article)
    article_parent.appendChild(new_element).innerHTML = `Suivre le lien : <a href="#">Voir le site</a>`;
    // new_element.style.color = "#ff0000" pour mettre de la couleur sur un element 
    new_element.children[0].style.color = "#ff0000"; // pour mettre juste le lien en couleur
